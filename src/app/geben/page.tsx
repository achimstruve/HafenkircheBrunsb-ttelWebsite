          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedChild delay={0.15} direction="left">
              <div className="flex justify-center lg:justify-end">
                <div className="relative w-[400px] h-[400px] md:w-[540px] md:h-[540px] drop-shadow-[0_0_48px_rgba(235,213,50,0.12)]">
                  <Image
      ...
      <section className="py-24 bg-[#d4e0f0]">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <AnimatedChild>
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-[#0E395B] mb-6">
                  Bankverbindung
                </h2>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={item.label}
                      className="flex items-center justify-between p-5 rounded-xl glass-card hover:border-[#EBD532]/40 transition-all duration-200 group"
                    >
                      <div>
                        <p className="text-[#5e76a0] text-xs font-semibold uppercase tracking-wider mb-1">
                          {item.label}
                        </p>
                        <p className="text-[#0E395B] font-mono font-semibold">{item.value}</p>
                      </div>
                      <Copy className="w-4 h-4 text-gray-600 group-hover:text-[#c45aa0] transition-colors duration-200" />
                    </div>
                  ))}
                </div>

                <div className="mt-8 p-5 rounded-xl bg-[#EBD532]/10 border border-[#EBD532]/20 flex gap-3">
                  <Mail className="w-5 h-5 text-[#c45aa0] shrink-0 mt-0.5" />
                  <div>
                    <p className="text-[#0E395B] font-semibold text-sm mb-1">
                      Spendenbescheinigung anfordern
                    </p>
                    <p className="text-[#3f5f86] text-sm">
                      Schreib uns einfach eine E-Mail an{' '}
                      <a
                        href="mailto:buchhaltung@hafenkirche.com"
                        className="text-[#c45aa0] hover:underline"
                      >
                        buchhaltung@hafenkirche.com
                      </a>{' '}
              ...
              <div className="space-y-6">
                ...
                <div className="glass-card rounded-2xl p-8">
                  <div className="flex items-center gap-4 mb-5">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#EBD532]/20 to-[#EBD532]/5 border border-[#EBD532]/30 flex items-center justify-center">
                      <Shield className="w-6 h-6 text-[#c45aa0]" />
                    </div>
                    <h3 className="text-[#0E395B] font-bold text-xl">Steuerlich absetzbar</h3>
                  </div>
                  <p className="text-[#3f5f86] leading-relaxed">
                ...
                <div className="glass-card rounded-2xl p-8">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-[#0E395B] font-bold text-xl">Wofür deine Spende wirkt</h3>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    {supportedWork.map((item) => (
                      <div
                        key={item.label}
                        className="flex items-center gap-2 text-sm text-[#3f5f86] py-1"
                      >
                        <span>{item.icon}</span>
      ...
      <section className="py-24 bg-[#c8d7ea]">
        <div className="container-max">
          <div className="max-w-3xl mx-auto text-center">
            <AnimatedChild>
              <h2 className="text-4xl md:text-5xl font-black text-[#0E395B] mb-8">
                Geben aus Freude
              </h2>
              <p className="text-[#345278] text-xl leading-relaxed mb-8">
              ...
              <p className="text-[#3f5f86] text-lg leading-relaxed">
