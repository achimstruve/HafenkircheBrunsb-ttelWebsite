  ...
  return (
    <>
      ...
      <section className="pt-32 pb-20 bg-[#dfe8f5] relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-10%,rgba(235,213,50,0.12),transparent)] pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedChild delay={0.15} direction="left">
              <div className="flex justify-center lg:justify-end">
                <div className="relative w-[380px] h-[380px] md:w-[500px] md:h-[500px] drop-shadow-[0_0_48px_rgba(235,213,50,0.1)]">
                  <Image
      ...
      {/* Harbour quote */}
      <section className="py-20 bg-[#d4e0f0] border-t border-[#0E395B]/10">
        <div className="container-max">
          <div className="max-w-4xl mx-auto">
            <AnimatedChild>
              <div className="relative pl-8 md:pl-12 border-l-4 border-[#EBD532]">
                {/* Anchor icon */}
                <div className="flex items-center gap-3 mb-6">
                  <div className="relative w-9 h-9 shrink-0 opacity-80">
                    <Image src="/logo-icon.png" alt="" fill className="object-contain" />
                  </div>
                  <span className="text-[#c45aa0] text-xs font-semibold tracking-[0.3em] uppercase">
                    Was unser Name bedeutet
                  </span>
                </div>
                {/* Decorative opening quote */}
                <span
                  className="absolute -top-4 left-6 md:left-10 text-[7rem] leading-none text-[#c45aa0]/15 font-serif select-none pointer-events-none"
                  aria-hidden="true"
                >
                  „
                </span>
                <blockquote className="text-[#0E395B] text-lg md:text-2xl leading-[1.85] font-light italic relative z-10">
        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto">
            <AnimatedChild>
              <div className="glass-card rounded-3xl p-10 md:p-16 mb-16">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div className="h-px flex-1 bg-gradient-to-r from-[#EBD532]/40 to-transparent" />
                </div>
                <p className="text-[#0E395B] text-lg md:text-xl leading-[1.9] font-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <AnimatedChild delay={0.1}>
                <div className="space-y-6 text-[#345278] text-lg leading-relaxed">
                  <p>
                    Wir glauben, dass sich Jesu Herz unter anderem durch das{' '}
                    <span className="text-[#c45aa0] font-semibold">Weitersagen</span> und das{' '}
                    <span className="text-[#c45aa0] font-semibold">Vorleben</span> seiner frohen
                    Botschaft zeigt.
                  </p>
                  <p>
              ...
              <AnimatedChild delay={0.2}>
                <div className="space-y-6 text-[#345278] text-lg leading-relaxed">
                  <p>
                    ...
                    <span className="text-[#c45aa0] font-semibold">Jesus Christus</span> und sein
            ...
            <AnimatedChild delay={0.3}>
              <div className="p-8 rounded-2xl bg-gradient-to-br from-[#EBD532]/10 to-transparent border border-[#EBD532]/20 text-center">
                <p className="text-2xl md:text-3xl font-bold text-[#0E395B] leading-relaxed italic">
        ...
        <div className="container-max">
          <AnimatedChild>
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-[#0E395B]">
                Was uns trägt
              </h2>
            </div>
          </AnimatedChild>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {pillars.map((pillar) => (
              <StaggerItem key={pillar.title}>
                <div className="flex gap-6 p-8 rounded-2xl glass-card hover:border-[#EBD532]/40 transition-all duration-300 group">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#EBD532]/20 to-[#EBD532]/5 border border-[#EBD532]/30 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300">
                    <pillar.icon className="w-6 h-6 text-[#c45aa0]" />
                  </div>
                  <div>
                    <h3 className="text-[#0E395B] font-bold text-lg mb-3">{pillar.title}</h3>
                    <p className="text-[#3f5f86] leading-relaxed">{pillar.text}</p>
                  </div>
                </div>
              </StaggerItem>
            ))}
      ...
      {/* CTA */}
      <section className="py-24 bg-[#dfe8f5] text-center">
        <div className="container-max">
          <AnimatedChild>
            <h2 className="text-4xl md:text-5xl font-black text-[#0E395B] mb-6">
              Teil dieser Vision werden?
            </h2>
            <p className="text-[#3f5f86] text-xl max-w-xl mx-auto mb-10">
